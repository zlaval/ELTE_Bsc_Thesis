...
import com.zlrx.thesis.videoservice.domain.TenantAwareEntity
...
open class TenantAwareMongoTemplate(
    ...
    override fun executeQuery(
        query: Query,
        collectionName: String,
        dch: DocumentCallbackHandler
    ) {
        executeQuery(
            query.withTenant(null, collectionName),
            collectionName,
            dch, QueryCursorPreparer(query.withTenant(null, collectionName), null)
        )
    }
