...
import com.zlrx.thesis.authservice.config.Messages.ERROR_DETAIL
import com.zlrx.thesis.authservice.config.Messages.ERROR_TITLE
import com.zlrx.thesis.authservice.config.Messages.INVALID_CREDENTIALS
import com.zlrx.thesis.authservice.config.Messages.VALIDATION_DEFAULT_MESSAGE
import com.zlrx.thesis.authservice.config.Messages.VALIDATION_ERROR_DETAIL
import com.zlrx.thesis.authservice.config.Messages.VALIDATION_ERROR_TITLE
...
class RestErrorHandler(
    ...
    fun handleAuthorizationError(error: AccessDeniedException): ResponseEntity<*> {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(getMessage(INVALID_CREDENTIALS))
    }
