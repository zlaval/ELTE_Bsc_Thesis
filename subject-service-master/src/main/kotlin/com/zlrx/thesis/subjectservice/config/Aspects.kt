...
import com.zlrx.thesis.subjectservice.config.Messages.ERROR_DETAIL
import com.zlrx.thesis.subjectservice.config.Messages.ERROR_TITLE
import com.zlrx.thesis.subjectservice.config.Messages.VALIDATION_DEFAULT_MESSAGE
import com.zlrx.thesis.subjectservice.config.Messages.VALIDATION_ERROR_DETAIL
import com.zlrx.thesis.subjectservice.config.Messages.VALIDATION_ERROR_TITLE
...
class RestErrorHandler(
    ...
    fun handleValidationError(error: BindException): ResponseEntity<ProblemDetail> {
        ...
        problemDetail.type = URI("/subject")
