...
import com.zlrx.thesis.enrollmentservice.config.Messages.ERROR_DETAIL
import com.zlrx.thesis.enrollmentservice.config.Messages.ERROR_TITLE
...
class RestControllerLoggingAop() {
    ...
    fun logControllerMethodCall(jp: JoinPoint) {
        logger.info { "${jp.signature.declaringTypeName}.${jp.signature.name}" }
    }
}
...
class RestErrorHandler(
    ...
    fun handleError(e: Exception): ResponseEntity<ProblemDetail> {
        ...
        problemDetail.type = URI("/enrollment")
